...
v0.2.3 ships **two prototypes** out of a 6-prototype kit:
...
v0.2.3 is a staged-validation release shipping **two prototypes** out of a 6-prototype kit. Subsequent versions ship the rest as each prototype passes its own empirical Lovable scaffold test (per the per-prototype publication patch pass discipline):
